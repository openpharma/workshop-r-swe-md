...
-   Statistician in Advanced Exploratory Analytics at Novartis
-   Joined Novartis in early-development Oncology in 2017
-   Open-source contributions include R package `OncoBayes2` (Bayesian model-based dose escalation)
-   Member of ASA BIOP working group on Software Engineering (SWE WG) Bayesian MMRM workstream
...
::: columns
::: {.column width="70%"}
-   Ph.D. in Statistics from University of Connecticut in 2021
-   Senior biostatistician at Johnson & Johnson
...
- The source files are hosted at [github.com/openpharma/workshop-r-swe-md](https://github.com/openpharma/workshop-r-swe-md), which is forked from the original version at [github.com/kkmann/workshop-r-swe](https://github.com/kkmann/workshop-r-swe/).
